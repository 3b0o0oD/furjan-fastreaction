    ...
    def closeEvent(self, event):
        ...
        if hasattr(self, 'teamscore_qml') and self.teamscore_qml:
            try:
                ...
                try:
                    self.teamscore_qml.statusChanged.disconnect()
                    self.teamscore_qml.sceneGraphError.disconnect()
                except:
                    pass
                ...
                logger.warning(f"️  Error cleaning up TeamScore QML widget: {e}")
            finally:
        ...
        if hasattr(self, 'teamscore_backend') and self.teamscore_backend:
            try:
                ...
                logger.warning(f"️  Error cleaning up TeamScore backend: {e}")
        ...
        try:
            if hasattr(self, 'Background') and self.Background is not None:
                try:
                    # Stop and delete movie if exists
...
class Active_screen(QWidget):
    ...
    def closeEvent(self, event):
        ...
        try:
            ...
            logger.warning(f"️  Error cleaning up circular timer: {e}")
        ...
        if hasattr(self, 'qml_widget') and self.qml_widget:
            try:
                ...
                logger.warning(f"️  Error cleaning up QML widget: {e}")
            finally:
                self.qml_widget = None
                self.qml_widget_initialized = False
    ...
    def closeEvent(self, event):
        ...
        if hasattr(self, 'teamname_qml') and self.teamname_qml:
            try:
                ...
                # Disconnect all signals before deletion
                try:
                    self.teamname_qml.statusChanged.disconnect()
                    self.teamname_qml.sceneGraphError.disconnect()
                except:
                    pass
                ...
                logger.warning(f"️  Error cleaning up TeamName QML widget: {e}")
            finally:
        ...
        if hasattr(self, 'team_backend') and self.team_backend:
            try:
                ...
                logger.warning(f"️  Error cleaning up team backend: {e}")
        ...
        # Clean up background (stop/delete movie first if present)
        if hasattr(self, 'Background') and self.Background:
            try:
                if hasattr(self, 'background_movie') and self.background_movie is not None:
                    try:
...
# Connect audio signals for sound effects (optional - game continues even if this fails)
    ...
    def _cleanup_previous_screens(self):
        ...
        # Clean up background label if it exists
        ...
        if hasattr(self, 'ui_active') and self.ui_active:
            try:
                ...
                # Clean up QML widgets
                if hasattr(self.ui_active, 'qml_widget') and self.ui_active.qml_widget:
                    try:
                        self.ui_active.qml_widget.deleteLater()
                    except:
                        pass
                    self.ui_active.qml_widget = None
                
                # Clean up QML backend
                if hasattr(self.ui_active, 'fastreaction_backend') and self.ui_active.fastreaction_backend:
                    try:
                        self.ui_active.fastreaction_backend.stop_countdown()
                    except:
                        pass
                    self.ui_active.fastreaction_backend = None
        ...
        if hasattr(self, 'ui_final') and self.ui_final:
            try:
                ...
                # Clean up QML widgets
                if hasattr(self.ui_final, 'teamscore_qml') and self.ui_final.teamscore_qml:
                    try:
                        self.ui_final.teamscore_qml.deleteLater()
                    except:
                        pass
                    self.ui_final.teamscore_qml = None
                
                # Clean up QML backend
                if hasattr(self.ui_final, 'teamscore_backend') and self.ui_final.teamscore_backend:
                    self.ui_final.teamscore_backend = None
        ...
        if hasattr(self, 'ui_team_member') and self.ui_team_member:
            try:
                ...
                # Clean up QML widgets
                if hasattr(self.ui_team_member, 'teamname_qml') and self.ui_team_member.teamname_qml:
                    try:
                        self.ui_team_member.teamname_qml.deleteLater()
                    except:
                        pass
                    self.ui_team_member.teamname_qml = None
                
                # Clean up QML backend
                if hasattr(self.ui_team_member, 'team_backend') and self.ui_team_member.team_backend:
                    self.ui_team_member.team_backend = None
