...
class Active_screen(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        if MainWindow.geometry().width() > 1920:
            self.movie = QMovie("Assets/1k/FastReaction_Activee.gif")
            self.movie.setCacheMode(QMovie.CacheAll)
            print("1")
            self.scale = 2
        else:
        ...
        self.label.setGeometry(QtCore.QRect(456*self.scale, 310*self.scale, 1006*self.scale, 158*self.scale))
        ...
        self.label_Score.setGeometry(QtCore.QRect(708*self.scale, 540*self.scale, 503*self.scale, 158*self.scale))
